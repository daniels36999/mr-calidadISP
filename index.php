   ...
   <body class="main-layout">
                           ...
                           <div class="collapse navbar-collapse" id="navbarsExample04">
                              <ul class="navbar-nav mr-auto">
                                 <li class="nav-item active">
                                    <a class="nav-link dx-id-index" href="index.php"> Inicio  </a>
                                 </li> 
                                 <li class="nav-item">
      ...
      <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel">
         ...
         <div class="carousel-inner">
            ...
            <img src="/images/portada2.png" class="d-block w-100 c-img" alt="Slide 1">
            <div class="dx-txt-banner carousel-caption top-0 mt-4">
               <img  class="dx-img-banner" src="/images/logo1.png" alt="">
               <p class="mt-5 fs-3 text-uppercase">Conoce Tu Paquete de Internet</p>
               <h1 class="fw-bolder text-capitalize">Velocidad & Calidad</h1>
               <div class="dx-botones-banner">
                  <a href="https://megared.ec" target="_blank"><button class="dx-btn-banner">Página Oficial</button></a>
                  <a href="/consulta.php"><button class="dx-btn-banner">Consultas</button></a>
               </div>
            </div>
            </div>
            <div class="carousel-item c-item">
            <img src="/images/portada1.png" class="d-block w-100 c-img" alt="Slide 2">
            <div class="dx-txt-banner carousel-caption top-0 mt-4">
               <img  class="dx-img-banner" src="/images/logo1.png" alt="">
               <p class="mt-5 fs-3 text-uppercase">Conoce Tu Paquete de Internet</p>
               <h1 class="fw-bolder text-capitalize">Velocidad & Calidad</h1>
            ...
            <div class="row d_flex">
               <div class="col-md-7">
                  <div class="titlepage">
                     <h2>Nosotros</h2>
                     <span></span>
                     <p>Megared, somos proveedores de servicios de telecomunicaciones, llegamos con Fibra Óptica mediante la tecnología FTTH (XGPON), contamos con la más alta capacidad de internet de la provincia, brindamos redundancia en nuestro servicio por los distintos anillos de la red física tendida en el altiplano orense.</p>
                     <a class="read_more" href="https://megared.ec" target="_blank">saber más<i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                  </div>
               </div>
               <div class="col-md-5">
                  <div class="about_img">
                     <figure><img src="images/nosotros.jpg" alt="#"/></figure>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row d_flex">
               <div class="col-md-5">
                  <div class="mobile_img">
                     <figure><img src="images/contacto.png" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-7">
                  <div class="titlepage">
